...
class resultClass:
    def __init__(self,root):
        ...
        #======title=======
        title=Label(self.root, text="Add Students Result",font = ("goudy old style",20,"bold"),bg = "orange",fg="#262626").place(x=10,y=15,width=1180,height=50)
        ...
        lbl_select = Label(self.root, text="Select Student", font=("goudy old style", 20, "bold"))
